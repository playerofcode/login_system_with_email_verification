...
{
$email=$row['email'];
mysqli_query($con,"update users set status=1,token='' where email='$email'");
						...
						<div class="card-body">
							<form action="" method="post">
								<div class="form-group">
									<input type="text" name="token" class="form-control" placeholder="Enter Your Verification Code">
								</div>
								<div class="form-group">
									<input name="submit" type="submit" class="btn btn-success" value="Verify Now">
								</div>
							</form>
						</div>
					</div>
